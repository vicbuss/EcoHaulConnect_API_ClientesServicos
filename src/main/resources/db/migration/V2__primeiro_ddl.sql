...
-- O atributo id_cliente em tb_servicos é uma chave estrangeira
-- Ele está ligado com id_cliente da tb_cliente
...
-- O atributo id_endereco em tb_servicos é uma chave estrangeira
-- Ele está ligado com id_endereco da tb_enderecos
...
-- O atributo id_transportador em tb_servicos é uma chave estrangeira
-- Ele está ligado com id_transportador da tb_transportadores
...
-- O atributo id_servico em tb_itens é uma chave estrangeira
-- Ele está ligado com id_servico da tb_servicos

ALTER TABLE tb_itens
ADD CONSTRAINT fk_tb_itens_tb_servicos
